...
public class OnlinePreviewController {
    ...
    public void getCorsFile(String urlPath, HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
        ...
        if (!urlPath.toLowerCase().startsWith("ftp:")){
            Map<String, String> headers = WebUtils.forwardAuthHeaders(request);
            try {
                ...
                headers.forEach(urlcon::setRequestProperty);
